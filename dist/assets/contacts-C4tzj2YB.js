import{c as a,a as i}from"./footer-PiBz2C01.js";document.addEventListener("DOMContentLoaded",()=>{const e=a();document.body.insertBefore(e,document.body.firstChild);const t=document.getElementById("app");t.innerHTML=`
    <div class="relative isolate bg-white">
      <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <!-- Right Section -->
        <div class="relative px-6 pb-10 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl class="mt-6 space-y-4 text-base leading-7 text-gray-600">
              <div class="flex gap-x-4">
                ...
                <dd>Via Giuseppe Buffi 13<br> 6900 Lugano (Switzerland)</dd>
              </div>
              <div class="flex gap-x-4">
                <dt class="flex-none">
                ...
                <dd><a class="hover:text-gray-900" href="tel:+41 78 209 41 52">+41 78 209 41 52</a></dd>
              </div>
              <div class="flex gap-x-4">
                <dt class="flex-none">
                ...
                <dd><a class="hover:text-gray-900" href="mailto:info@auroracapm.ch">info@auroracapm.ch</a></dd>
              </div>
            </dl>
          </div>
        </div>

        <!-- Left Section (Form Section with extra height) -->
        <form action="#" method="POST" class="px-6 pb-24 pt-48 sm:pb-32 lg:px-8 lg:py-72">
