import{c as a,a as l}from"./footer-DOIc-P5O.js";document.addEventListener("DOMContentLoaded",()=>{const e=a();document.body.insertBefore(e,document.body.firstChild);const t=document.getElementById("app");t.innerHTML=`
          ...
          <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl class="mt-6 space-y-4 text-base leading-7 text-gray-600">
              ...
              <div class="flex gap-x-4">
                ...
                <dd><a class="hover:text-gray-900" href="tel:+1 (555) 234-5678">+41 78 209 41 52</a></dd>
              </div>
              <div class="flex gap-x-4">
                <dt class="flex-none">
                ...
                <dd><a class="hover:text-gray-900" href="mailto:hello@example.com">info@auroracapm.ch</a></dd>
              </div>
            </dl>
          </div>
        </div>
