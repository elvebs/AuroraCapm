import{c,a as g}from"./footer-dk2leo8a.js";document.addEventListener("DOMContentLoaded",()=>{const r=c();document.body.insertBefore(r,document.body.firstChild);const a={lvhi:{name:"LVHI",description:"This ETF focuses on high-dividend, low-volatility equities in developed markets outside the U.S. By investing primarily in profitable companies with high dividend yields, LVHI aligns with our portfolio’s goal of minimizing volatility while providing steady income",ownership:"18.2"},sgld:{name:"SGLD.L",description:"SGLD.L provides direct exposure to gold, acting as a hedge against inflation and market downturns. With gold’s historical role as a safe-haven asset, this investment plays a critical part in reducing overall portfolio risk during market turbulence.",ownership:"15.2"},dgrw:{name:"DGRW",description:"DGRW targets U.S. dividend-paying stocks with strong growth potential. This fundamentally weighted index focuses on companies with robust earnings and dividend growth characteristics, enhancing the portfolio with both income and growth opportunities",ownership:"14.9"},dynf:{name:"DYNF",description:"DYNF employs a multi-factor approach to capture returns from various equity factors such as value, momentum, and quality. This diversified strategy offers a balanced way to enhance returns across different market conditions.",ownership:"13.6"},fndx:{name:"FNDX",description:"NDX provides exposure to large-cap developed market companies outside the U.S., focusing on fundamental metrics rather than market capitalization. This value-oriented approach prioritizes firms with strong financials, ensuring long-term stability",ownership:"10.2"},"xzmu.l":{name:"XZMU.L",description:"XZMU.L tracks the MSCI USA Low Carbon SRI Leaders Index, offering exposure to U.S. large- and mid-cap companies with low carbon emissions and high ESG ratings. This responsible investing strategy aligns with sustainable trends in the market",ownership:"10.1"},"006208.tw":{name:"006208.TW",description:"This ETF offers exposure to the top 50 companies listed on the Taiwan Stock Exchange, providing a gateway to the growing Taiwanese market. The focus on established firms enhances stability while capturing potential growth opportunities",ownership:"5.56"},argt:{name:"ARGT",description:"ARGT invests in companies listed in Argentina, providing diversification through exposure to this emerging market. This investment aims to capitalize on Argentinas unique economic landscape while balancing overall portfolio risk",ownership:"4.65"},"qdve.de":{name:"QDVE.DE",description:"QDVE.DE focuses on the technology sector within the S&P 500, investing in companies at the forefront of innovation and growth. This sector-specific strategy enhances exposure to technological advancements and growth potentia",ownership:"2.84"},"inr.pa":{name:"INR.PA",description:"This ETF provides exposure to large- and mid-cap companies in India, tapping into one of the fastest-growing economies globally. INR.PA offers diversification and potential growth through Indias robust market opportunities",ownership:"2.43"},mlpx:{name:"MLPX",description:"Global X MLP & Energy Infrastructure ETF offers investors exposure to the energy sector with a focus on master limited partnerships (MLPs). This investment provides diversification and income potential through energy infrastructure assets.",ownership:"1.63%"},DXJ:{name:"DXJ",description:"DXJ provides a hedge against currency fluctuations while investing in Japanese equities. This investment offers exposure to Japans market opportunities while mitigating currency risk.",ownership:"0.728%"}};function s(e){const o=document.getElementById("modal"),l=document.getElementById("modal-content"),t=a[e];t&&(l.innerHTML=`
